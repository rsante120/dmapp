    ...
    <td width="150" class="pt-2" >
        ...
        <script>
          function nueva_atencion(){
            ...
            AJAXPOST(url_base+"zmods/gfm/atencion_gine/ate_nuevo.php",a,dv,"L;");
          }
        </script>
      </td>
  </tr>
...
<script>
  ...
  function guardar_atencion(){
    ...
    $("#dv_formulario").hide();
    $("#dv_resultados").show();
    AJAXPOST(url_base+"zmods/gfm/atencion_gine/ate_save.php",a,dv,"L;loading");
  }
