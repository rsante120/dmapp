...
try {
  ...
  $sql = "INSERT INTO _atenciones SET 
    ate_tipo='ctrlgine',
    ate_fecha = '$fecha',
    ate_pac_id = '$idpac',
  ...
  if($idate == 0) {
  throw new Exception("Atencion no creada", 1);
  }


  $sql = "INSERT INTO  _atenciones_ctrlgine SET
    atdet_ate_id = '$idate',
    atdet_motivo = '$motivo',
    atdet_edad = '$edad',
  ...
  if($iddet == 0) {
  throw new Exception("Detalle no creado", 2);
  }
  wnav_mensaje_ok("Atención generada correctamente");
